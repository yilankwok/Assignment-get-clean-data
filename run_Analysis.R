# Basic assumption : The zip file (https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip) is downloaded and extracted and unziped in the Desktop.
...
# Set working directory to the zip file downloaded and extracted and unzip. Home Directory is set as the UCI HAR Dataset.
